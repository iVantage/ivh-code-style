var foo = function(wow, za) {
  // JS files are generally indented with two spaces as set in ./.editorconfig
  // New projects should get the standard iVantage editorconfig file. When
